...
module.exports.registerAndEnrollUser = async function (
   username,
   secret,
   userOrg,
   isJson
) {
   let user = await helper.registerAndEnrollUser(
      username,
      secret,
      userOrg,
      isJson
...
module.exports.invokeTransaction = function (
   channelName,
   chaincodeName,
   payloadArr,
   fName,
   ...
   return invoke.invokeTransaction(
      channelName,
      chaincodeName,
      payloadArr,
      fName,
...
module.exports.queryChaincode = function (
   channelName,
   chaincodeName,
   payloadArr,
   fName,
