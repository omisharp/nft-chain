...
auctionCtrl.closeOpenAuction = async function (req, res) {
   ...
   try {
      let auctionService = new AuctionService()
      let response = await auctionService.closeOpenAuction(
         req.body,
         req.decoded
      )
      return res.status(200).send(response)
...
auctionCtrl.getInitAuctionsByAH = async function (req, res) {
   ...
   try {
      let auctionService = new AuctionService()
      let response = await auctionService.getInitAuctionsByAuctionHouseID(
         req.decoded
      )
      return res.status(200).send(response)
   } catch (error) {
...
auctionCtrl.getOpenAuctionsByAH = async function (req, res) {
   ...
   try {
      let auctionService = new AuctionService()
      let response = await auctionService.getOpenAuctionsByAuctionHouseID(
         req.decoded
      )
      return res.status(200).send(response)
   } catch (error) {
...
auctionCtrl.getAuctionByID = async function (req, res) {
   ...
   try {
      let auctionService = new AuctionService()
      let response = await auctionService.getAuctionByID(
